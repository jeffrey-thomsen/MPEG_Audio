# this script is used to generate a numpy array containing the quantization coefficients for Layer II audio coding as defined in Table C.6 of the ISO/IEC 11172-3 (aka MPEG-1 Audio) standard
